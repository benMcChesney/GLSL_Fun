...
//	shader.load("shaders/noise.vert", "shaders/noise.frag");
    ...
    shader.load("shaders/twist.vert", "shaders/twist.frag" ) ; 
    ...
    gui->addWidgetDown( new ofxUISlider(dim,160, 0.0f , 1.0f , ambientColor.x, "R")); 
    gui->addWidgetRight( new ofxUISlider(dim,160, 0.0f , 1.0f , ambientColor.y, "G")); 
    gui->addWidgetRight( new ofxUISlider(dim,160, 0.0f , 1.0f , ambientColor.z, "B")); 
    gui->addWidgetRight( new ofxUISlider(dim,160, 0.0f , 1.0f , ambientColor.w, "A")); 
